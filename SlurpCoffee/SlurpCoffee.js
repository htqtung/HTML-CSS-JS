...
function run() {
    ...
    if (smallBag < 0 || mediumBag < 0 || largeBag < 0 || boxSize < 30 || boxSize > 100) {
        ...
        alert("Please enter valid number, for coffee bags, they should not be smaller than 0 and valid box sizes are from 30cm to 100cm.");
        divAnswer = "";
    }
    else if (smallBag == 0 && mediumBag == 0 && largeBag == 0) {
        console.log("The order is invalid. All three coffee bag fields are entered with 0.");
        alert("All three fields of coffee bag cannot be 0.");
        divAnswer = "";
    }
