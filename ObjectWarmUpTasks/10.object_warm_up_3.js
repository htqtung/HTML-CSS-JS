...
function translateTo(language) {
    ...
    document.getElementById("txtEnglishWord").value = "";
}
...
var wordArray = [ 
    ...
    { englishWord: "mouse", finnishWord: "hiiri", swedishWord: "mus" },
    { englishWord: "elephant", finnishWord: "norsu", swedishWord: "elefant" },
];
